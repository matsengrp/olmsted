...
class App extends React.Component {
  ...
  render() {
    const { browserDimensions, availableDatasets, dispatch, selectedFamily, selectedSeq, loadedClonalFamilies } =
      this.props;
              ...
              <div ref={this.sectionRefs.datasets} style={sectionStyle}>
                <CollapsibleSection titleText="Datasets">
                  <CollapseHelpTitle
                    ...
                    helpText={
                      <div>
                        The Datasets section allows you to manage and load your B-cell repertoire datasets. The table
                        displays all available datasets stored in your browser&apos;s local storage (IndexedDB),
                        including dataset name, number of clonal families, and loading status.
                        <br />
                        <br />
                        <strong>Loading Datasets:</strong>
                        <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                          <li>
                            <strong>Select datasets:</strong> Check the boxes in the &quot;Select&quot; column for
                            datasets you want to visualize
                          </li>
                          <li>
                            <strong>Update Visualization:</strong> Click this button to load selected datasets or unload
                            unselected ones
                          </li>
                          <li>
                            <strong>Status indicators:</strong> Color-coded labels show whether each dataset is loaded
                            (green), loading (blue), or unloaded (gray)
                          </li>
                        </ul>
                        <strong>Table Features:</strong>
                        <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                          <li>
                            <strong>Info button:</strong> Click the blue info icon to view all metadata fields for a
                            dataset
                          </li>
                          <li>
                            <strong>Sorting:</strong> Click column headers to sort. Click again to reverse order
                          </li>
                          <li>
                            <strong>Resize columns:</strong> Drag column borders to adjust width
                          </li>
                        </ul>
                        <strong>Managing Datasets:</strong>
                        <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                          <li>
                            <strong>Upload new data:</strong> Click &quot;Manage Datasets&quot; to return to the main
                            page where you can upload new datasets
                          </li>
                          <li>
                            <strong>Delete datasets:</strong> Use the &quot;Manage Datasets&quot; page to remove
                            datasets from local storage
                          </li>
                        </ul>
                        ...
                        <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                          ...
                          <li>
                            <strong>Starred first:</strong> Check this option to sort starred datasets to the top of the
                            table
                          </li>
                          <li>
                          ...
                          <li>
                            <strong>Bulk actions:</strong> Use &quot;Star All&quot; or &quot;Unstar All&quot; to quickly
                            star or unstar all currently visible datasets. Use &quot;Clear Stars&quot; to remove all
                            stars
                          </li>
                        </ul>
                        <strong>Export:</strong> Click &quot;Download Table as CSV&quot; to export the current table
                        view (with applied filters and sorting) to a CSV file.
                        <br />
                        <br />
                        Multiple datasets can be loaded simultaneously for comparative analysis across different samples
                        or subjects.
                      </div>
                    }
                  />
                ...
                <div ref={this.sectionRefs.clonalFamilies} style={sectionStyle}>
                  <CollapsibleSection titleText="Clonal Families">
                    <CollapseHelpTitle
                      ...
                      helpText={
                        <div>
                          The Clonal Families section represents each clonal family as a point in a scatterplot. Each
                          point corresponds to a single clonal family, with axes, size, color, and shape customizable to
                          display different family-level metrics and metadata. For paired heavy/light chain data, each
                          chain is represented as a separate data point. Interact with the plot by clicking individual
                          points or dragging to brush-select multiple clones, which filters the clonal families
                          displayed in the Selected Clonal Families table below. See the{" "}
                          <a href="https://github.com/matsengrp/olmsted#readme">README</a> to learn more about AIRR,
                          PCP, or Olmsted data schemas and field descriptions.
                          <br />
                          <br />
                          <strong>Filters:</strong> Use the &quot;Filters&quot; panel below to restrict which clonal
                          families are displayed. Filter by locus (IGH, IGK, IGL), subject, sample, V gene, J gene, or
                          dataset. Multiple values can be selected for each filter field. Active filters are shown as
                          chips that can be individually removed.
                          <br />
                          <br />
                          <strong>Control Modes:</strong> The scatterplot has two interaction modes accessible via
                          buttons in the upper right:
                          <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                            <li>
                              <strong>Select Mode:</strong> Click to select individual clones or drag to brush-select
                              multiple clones
                            </li>
                            <li>
                              <strong>Pan/Zoom Mode:</strong> Drag to pan the view and scroll to zoom in/out
                            </li>
                          </ul>
                          <strong>Note:</strong> The active mode is highlighted in blue. Clicking on the plot enters
                          focused mode, where scroll events will zoom the plot instead of scrolling the page. Click
                          outside the plot to exit focused mode and restore normal page scrolling.
                          <br />
                          <br />
                          <strong>Mouse + Keyboard Controls:</strong>
                          <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                            <li>
                              <strong>Click</strong> to select individual clones (Select Mode)
                            </li>
                            <li>
                              <strong>Drag</strong> to brush-select multiple clones (Select Mode) or pan the view
                              (Pan/Zoom Mode)
                            </li>
                            <li>
                              <strong>Scroll</strong> to zoom in/out (Pan/Zoom Mode)
                            </li>
                            <li>
                              <strong>Hold Shift:</strong> Temporarily switch to the opposite mode (Select ↔ Pan/Zoom)
                            </li>
                            <li>
                              <strong>Double-click:</strong> Reset zoom and pan to default view (Pan/Zoom Mode)
                            </li>
                          </ul>
                          <strong>Button Controls:</strong>
                          <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                            <li>
                              <strong>Select / Pan-Zoom:</strong> Toggle between interaction modes
                            </li>
                            <li>
                              <strong>+/−:</strong> Zoom in or out
                            </li>
                            <li>
                              <strong>Reset View:</strong> Reset zoom and pan to default view
                            </li>
                            <li>
                              <strong>Clear Selection:</strong> Deselect all selected clones
                            </li>
                          </ul>
                          <strong>Plot Customization:</strong> Use the dropdown menus below the plot to customize the
                          visualization:
                          <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                            <li>
                              <strong>X and Y axes:</strong> Map continuous variables to the x and y axes
                            </li>
                            <li>
                              <strong>Size by:</strong> Scale point size by a continuous variable
                            </li>
                            <li>
                              <strong>Color by:</strong> Color points by categorical variables
                            </li>
                            <li>
                              <strong>Shape by:</strong> Change point shape by categorical variables
                            </li>
                            <li>
                              <strong>Facet by:</strong> Split the plot into separate panels by categorical variables
                            </li>
                          </ul>
                          <strong>Export &amp; Display Options:</strong>
                          <ul style={{ marginTop: "5px", paddingLeft: "20px" }}>
                            <li>
                              <strong>Hide Plot Settings:</strong> Toggle off the on-plot settings panel for a cleaner
                              view
                            </li>
                            <li>
                              <strong>Export PNG/SVG:</strong> Save the scatterplot as an image
                            </li>
                          </ul>
                          <strong>Tip:</strong> Plot settings can be saved as configurations via the Settings menu in
                          the header.
                        </div>
                      }
                    />
                ...
                <div ref={this.sectionRefs.selectedClonalFamilies} style={{ paddingBottom: 40, ...sectionStyle }}>
                  <CollapsibleSection titleText="Selected Clonal Families">
                    <CollapseHelpTitle
                      ...
                      helpText={
                        <div>
                          The Selected Clonal Families table displays the full collection or selected subset of clonal
                          families (based on scatterplot selection). Each row represents one clonal family and includes:
                          <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                            <li>
                              <strong>Naive sequence visualization:</strong> Graphical representation of V(D)J
                          ...
                          <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                            <li>
                              <strong>Selection:</strong> Click a row or the checkbox in the &quot;Select&quot; column
                              to choose a clonal family for detailed visualization
                            </li>
                            <li>
                              <strong>Sorting:</strong> Click column headers to sort. Click again to reverse order
                            </li>
                            <li>
                              <strong>Info button:</strong> Click the blue info icon to view all available data fields
                              for a clonal family in a modal dialog
                            </li>
                            <li>
                              <strong>Resize columns:</strong> Drag column borders to adjust width
                            </li>
                          ...
                          <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                            ...
                            <li>
                              <strong>Persistence:</strong> Stars persist when the scatterplot selection changes,
                              allowing you to track families across multiple selections
                            </li>
                            <li>
                              <strong>Starred first:</strong> Check this option to sort starred families to the top of
                              the table
                            </li>
                            <li>
                              <strong>Only starred:</strong> Check this option to filter and show only starred families
                            </li>
                            <li>
                              <strong>Bulk actions:</strong> Use &quot;Star All&quot; or &quot;Unstar All&quot; to
                              quickly star or unstar all currently visible families. Use &quot;Clear Stars&quot; to
                              remove all stars from the entire dataset
                            </li>
                          </ul>
                          <strong>Export:</strong> Click &quot;Download Table as CSV&quot; to export the current table
                          view (with applied filters and sorting) to a CSV file.
                          <br />
                          <br />
                          When you select a clonal family from the table, its phylogenetic tree and alignment are
                          displayed below in the Clonal Family Details section. For paired heavy/light chain data, trees
                          for both chains will be available.
                        </div>
                      }
                    />
