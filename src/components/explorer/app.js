...
/**
 * Datasets section — dataset loading table with help text.
 */
function DatasetsSection({ sectionRef, availableDatasets, dispatch }) {
  return (
    <div ref={sectionRef} style={sectionStyle}>
      <CollapsibleSection titleText="Datasets">
        <CollapseHelpTitle
          ...
          helpText={
            <div>
              The Datasets section allows you to manage and load your B-cell repertoire datasets. The table displays all
              available datasets stored in your browser&apos;s local storage (IndexedDB), including dataset name, number
              of clonal families, and loading status.
              <br />
              <br />
              <strong>Loading Datasets:</strong>
              <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                <li>
                  <strong>Select datasets:</strong> Check the boxes in the &quot;Select&quot; column for datasets you
                  want to visualize
                </li>
                <li>
                ...
                <li>
                  <strong>Status indicators:</strong> Color-coded labels show whether each dataset is loaded (green),
                  loading (blue), or unloaded (gray)
                </li>
              </ul>
              <strong>Table Features:</strong>
              <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                <li>
                  <strong>Info button:</strong> Click the blue info icon to view all metadata fields for a dataset
                </li>
                <li>
              ...
              <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                <li>
                  <strong>Upload new data:</strong> Click &quot;Manage Datasets&quot; to return to the main page where
                  you can upload new datasets
                </li>
                <li>
                  <strong>Delete datasets:</strong> Use the &quot;Manage Datasets&quot; page to remove datasets from
                  local storage
                </li>
              </ul>
              ...
              <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                ...
                <li>
                  <strong>Bulk actions:</strong> Use &quot;Star All&quot; or &quot;Unstar All&quot; to quickly star or
              ...
              <br />
              <br />
              Multiple datasets can be loaded simultaneously for comparative analysis across different samples or
              subjects.
            </div>
          }
        />
        ...
        <CollapseHelpTitle
          ...
          helpText={
            <div>
              ...
              <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                <li>
                  <strong>Select Mode:</strong> Click to select individual clones or drag to brush-select multiple
                  clones
                </li>
                <li>
              ...
              <strong>Note:</strong> The active mode is highlighted in blue. Clicking on the plot enters focused mode,
              where scroll events will zoom the plot instead of scrolling the page. Click outside the plot to exit
              focused mode and restore normal page scrolling.
              <br />
              <br />
              ...
              <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                ...
                <li>
                  <strong>Drag</strong> to brush-select multiple clones (Select Mode) or pan the view (Pan/Zoom Mode)
                </li>
                <li>
        ...
        <CollapseHelpTitle
          ...
          helpText={
            <div>
              ...
              <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                <li>
                  <strong>Naive sequence visualization:</strong> Graphical representation of V(D)J recombination showing
                  gene segments and CDR regions
                </li>
                <li>
                  <strong>Metadata:</strong> Clone ID, unique sequence count (equivalent to rearrangement count in AIRR
                  terminology), mutation frequency, and other family-level statistics
                </li>
              </ul>
              <strong>Table Interactions:</strong>
              <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                <li>
                  <strong>Selection:</strong> Click a row or the checkbox in the &quot;Select&quot; column to choose a
                  clonal family for detailed visualization
                </li>
                <li>
                  <strong>Sorting:</strong> Click column headers to sort. Click again to reverse order
                </li>
                <li>
                  <strong>Info button:</strong> Click the blue info icon to view all available data fields for a clonal
                  family in a modal dialog
                </li>
                <li>
                  <strong>Resize columns:</strong> Drag column borders to adjust width
                </li>
              ...
              <ul style={{ marginTop: "5px", paddingLeft: "20px", marginBottom: "10px" }}>
                ...
                <li>
                  <strong>Persistence:</strong> Stars persist when the scatterplot selection changes, allowing you to
                  track families across multiple selections
                </li>
                <li>
                  <strong>Starred first:</strong> Check this option to sort starred families to the top of the table
                </li>
                <li>
                ...
                <li>
                  <strong>Bulk actions:</strong> Use &quot;Star All&quot; or &quot;Unstar All&quot; to quickly star or
                  unstar all currently visible families. Use &quot;Clear Stars&quot; to remove all stars from the entire
                  dataset
                </li>
              </ul>
              <strong>Export:</strong> Click &quot;Download Table as CSV&quot; to export the current table view (with
        ...
        <span>
          ...
          <div>
            <div style={usableWidthStyle(availableWidth)}>
              <DatasetsSection
                sectionRef={this.sectionRefs.datasets}
