...
export const colorOptions = {
  ...
  ne: {
    ...
    menuItem: "nonepitope mutations",
    type: "continuous"
  },
  rb: {
    key: "rb",
    legendTitle: "Receptor Binding Mutations",
    menuItem: "RBS mutations",
    type: "continuous"
  },
  gt: {
    key: "genotype",
...
export const dHIScale = scaleLinear().domain([0, 1]).range([2.0, 4.5]);

export const freqScale = scaleSqrt().domain([0, 1]).range([1, 10]);

export const distanceScale = scaleSqrt().domain([3, 20]).range([9, 3]).clamp([true]);
